...
class hpPage(QMainWindow):
    ...
    def paketBilgisi(self):
        ...
        # Point 1 Point 2 için değişken ekle
            
        #paket tablosu-> isim,soyisim,telefon,gonderici_gemi,hedef_gemi,kalkis_noktasi,hedef_nokta
        #---------------------------------------------------             
        myCursor = mydb.cursor() # Veritabani baglantisi
        # Veri ekleme (Insert Into komutu)       
        sql = "INSERT INTO paket (isim,soyisim,telefon,gonderici_gemi,hedef_gemi,home_lat,home_lon) VALUES (%s,%s,%s,%s,%s,%s,%s)"
        values = (gondericiAdi,gondericiSoyad,gondericiTel,gonderenGemi,hedefGemi,home_lat,home_lon)
